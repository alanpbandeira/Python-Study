...
class BlogPostDAO:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            op = self.posts.update_one({"permalink":permalink}, {"$push":{"comments":comment}})
            return op.modified_count  # Change this to return the number of documents updated by the code for HW 3.3
